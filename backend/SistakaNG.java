...
public class SistakaNG {
    ...
    /**
     * Method ini akan membuat String[] yang berisi hanya nama - nama dari kategori di daftar kategori
     * @return String[]
     */
    // Method tambahan
    public static String[] getDaftarNamaKategori(){
        ArrayList<String> daftarNamaKategori = new ArrayList<>();
        for (Kategori k: daftarKategori){
            daftarNamaKategori.add(k.getNama());
        }
        return daftarNamaKategori.toArray(new String[0]);
    }

    /**
     * Method ini akan membuat String[] yang berisi hanya judul dan penulis buku di daftar buku
     * @return String[]
     */
    public static String[] getDaftarJudulDanPenulisBuku(){
        ArrayList<String> daftarNamaDanPenulisBuku = new ArrayList<>();
        for (Buku b: daftarBuku){
            daftarNamaDanPenulisBuku.add(b.toString());
        }
        return daftarNamaDanPenulisBuku.toArray(new String[0]);
    }

    /**
     * Method ini akan membuat String[] yang berisi hanya id dari anggota di daftar anggota
     * @return String[]
     */
    public static String[] getDaftarIdAnggota(){
        ArrayList<String> daftarIdAnggota = new ArrayList<>();
        for (Anggota a: daftarAnggota){
            daftarIdAnggota.add(a.getId());
        }
        return daftarIdAnggota.toArray(new String[0]);
    }
